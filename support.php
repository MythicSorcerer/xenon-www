<?php
$markdownFile = 'support.md';
$markdownText = file_exists($markdownFile) ? file_get_contents($markdownFile) : '# Support information not found';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
  ...
  <main class="faq-container">
    <div class="faq-title">Support</div>
