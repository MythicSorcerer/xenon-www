...
- Hamburger menu
- Remake background animations and entire css for light mode (White + black + dark blue theme) instead of (Black + Neon Blue + White) in light-mode.css
	- Light mode changes:
	- No background animation
	- No glow/shadows around boxes
